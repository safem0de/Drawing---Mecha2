...
Public Class StandardFunction
    ...
    'Public Shared Sub fillMySQLDataToDataGrid(targetDataGridView As GridView, sqlCommandStr As String)
    '    Dim dt As DataTable = getMySQLDataTable(sqlCommandStr)
    ...
    'Public Shared Function getMySQLDataTable(strSQL As String) As DataTable
    ...
    '    objConn.ConnectionString = StandardFunction.MySQLconnectionString
    '    objConn.Open()
    ...
    Public Shared Sub ExportExcel(TargetPage As Page, SqlString As String, fileName As String)
        ...
        Dim dt As DataTable = StandardFunction.GetDataTable(SqlString)
